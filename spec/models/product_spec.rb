...
RSpec.describe Product, type: :model do
  describe 'Validations' do
    ...
    it 'should not save when the price field is left blank' do
      @category = Category.new(name: 'Miscellaneous')
      @product = Product.new(name: 'Soccerball', price: nil, quantity: 48, category: @category)
    ...
    it 'should not save when the quantity field is left blank' do
      @category = Category.new(name: 'Miscellaneous')
      @product = Product.new(name: 'Soccerball', price: 3000, quantity: nil, category: @category)
    ...
    it 'should not save when the category field is left blank' do
      @category = Category.new(name: 'Miscellaneous')
      @product = Product.new(name: 'Soccerball', price: 3000, quantity: 48, category: nil)
